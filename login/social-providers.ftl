<#macro show social>
  ...
  <div id="kc-social-providers" class="card">
      <div class="card-body">
          <div class="d-flex flex-wrap gap-2 justify-content-center">
              <#list social.providers as p>
                  <a data-once-link id="social-${p.alias}"
                        ...
                        <#switch p.alias>
                            <#case "google">
                                <svg viewBox="0 0 48 48" class="google" aria-hidden="true" width="18" height="18">
                                ...
                                <#break>
                            <#case "github">
                                <svg aria-hidden="true" viewBox="0 0 496 512" width="18" height="18">
                                ...
                                <#break>
                            <#case "facebook">
                                <svg aria-hidden="true" viewBox="0 0 448 512" width="18" height="18">
                            ...
                            <#case "linkedin-openid-connect">
                                ...
                                <#break>
                            <#case "openshift-v4">
                                <svg viewBox="116 0 100 100" aria-hidden="true" width="18" height="18">
                                ...
                                <#break>
                            <#case "stackoverflow">
                                <svg viewBox="0 0 384 512" aria-hidden="true" width="18" height="18">
                                ...
                                <#break>
                            <#case "twitter">
                                <svg viewBox="0 0 1200 1227" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg" width="18" height="18">
                                    <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" fill="white"/>
                                </svg>
                                <#break>
                            <#case "microsoft">
                                <svg viewBox="0 0 448 512" aria-hidden="true" width="18" height="18">
                                    <path d="M0 32h214.6v214.6H0V32zm233.4 0H448v214.6H233.4V32zM0 265.4h214.6V480H0V265.4zm233.4 0H448V480H233.4V265.4z"></path>
                                </svg>
                                <#break>
                            <#case "bitbucket">
                                <svg viewBox="0 0 512 512" aria-hidden="true" width="18" height="18">
